...
namespace core
{
	namespace reports
	{
		...
		public:
			 ...
			 * @param i_on_progress 
			 */
			generator(source_data_t i_data, const str& i_filename, const empty_subscription_function_t i_on_finish, const subscription_function_t<size_t> i_on_progress);
