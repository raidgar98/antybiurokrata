...
class logger
{
 public:
	...
	template<log_level lvl> constexpr static void set_current_log_level() { logger::level = lvl; }
	constexpr static void set_default_log_level() { set_current_log_level<log_level::DEBUG>(); }
	template<log_level lvl> struct switch_log_level_keeper
	{
	 ...
	 */
	template<class T> static logger _get_logger(const char* alternative = "unknown")
	{
	...
	inline static format_function reset_color_scheme
		 = [](std::ostream& os) -> std::ostream& { return os << rang::bg::reset << rang::fg::reset; };
	inline static format_function debug_color_scheme
	...
	inline static format_function debug_format = [](std::ostream& os) -> std::ostream& {
		logger::debug_color_scheme(os);
		return os << "[DEBUG]";
	};
	inline static format_function info_format = [](std::ostream& os) -> std::ostream& {
		logger::info_color_scheme(os);
		return os << "[INFO]";
	};
	inline static format_function warn_format = [](std::ostream& os) -> std::ostream& {
		logger::warn_color_scheme(os);
		return os << "[WARNING]";
	};
	inline static format_function erro_format = [](std::ostream& os) -> std::ostream& {
		logger::erro_color_scheme(os);
		return os << "[ERROR]";
	};
...
template<typename T> class Log
{
 public:
	 ...
	 */
	static logger& get_logger() { return log; }
};
